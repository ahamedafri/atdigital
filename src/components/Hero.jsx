...
const Hero = () => {
  return (
    <div className="hero-container">
      ...
      <div className="p-4 hero-content-wrapper md:w-2/5 md:h-2/5 md:pb-14 md:absolute md:top-[70%] md:left-12 z-50" style={{ backgroundImage: 'linear-gradient(to right, #4DCA79, #1CBDDD)'}}>  {/* Apply styles for md */}
